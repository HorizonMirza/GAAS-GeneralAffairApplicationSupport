...
public class PerbaikanSaranaController : ApiControllerBase
{
    ...
    private static (string divisi, string? departemen, RoleEnum createdByRole) EffectiveOwner(User user, PerbaikanSaranaCreate payload)
    {
        ...
        bool onlyOnApproval = false)
    {
        ...
        {
            // Full access (see IsGaActor/CanAccessPerbaikanSarana) - no status or ownership
