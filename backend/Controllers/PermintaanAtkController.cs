...
public class PermintaanAtkController : ApiControllerBase
{
    ...
    private static (string divisi, string? departemen, RoleEnum createdByRole) EffectiveOwner(User user, PermintaanAtkCreate payload)
    {
        ...
        bool onlyOnApproval = false)
    {
        ...
        {
            // Full access (see IsGaActor/CanAccessPermintaanAtk) - no status or ownership
