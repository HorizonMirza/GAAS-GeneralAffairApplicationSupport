...
public class BookingKendaraan
{
    ...
    // BookingKendaraanController.Cancel) so the status badge can show who called it off without
    ...
    // status, same lifecycle as CancelledByName. Mirrors BookingRuang.CancelledByRole.
