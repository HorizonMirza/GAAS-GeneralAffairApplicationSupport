...
public class PermintaanArsipCreate
{
    ...
    // PermintaanArsipController.EffectiveOwner) - ignored for every other role, since they always
...
public record KoreksiArsipRequest(string LokasiPenyimpanan, string NamaPic, string NoTeleponPic, string? Catatan = null);
