...
public class PengirimanCreate
{
    ...
    // PengirimanController.EffectiveOwner) - ignored for every other role, since they always
    // create as themselves. Null keeps the old behavior (stamped as SUPER_ADMIN itself, same as
    // any other GA-actor role).
