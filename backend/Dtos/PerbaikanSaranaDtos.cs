...
public class PerbaikanSaranaCreate
{
    ...
    // PerbaikanSaranaController.EffectiveOwner) - ignored for every other role, since they always
...
public record KoreksiSaranaRequest(string NamaPelapor, string NoTeleponPelapor, string Lokasi, string? Catatan = null);
