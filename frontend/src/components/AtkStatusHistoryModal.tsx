...
import type { PermintaanAtkLog } from "@/lib/types";
...
export default function AtkStatusHistoryModal({ open, itemId, onClose }: Props) {
  const [logs, setLogs] = useState<PermintaanAtkLog[] | null>(null);
