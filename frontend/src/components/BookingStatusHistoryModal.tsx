...
import type { BookingRuangLog } from "@/lib/types";
...
export default function BookingStatusHistoryModal({ open, itemId, onClose }: Props) {
  const [logs, setLogs] = useState<BookingRuangLog[] | null>(null);
