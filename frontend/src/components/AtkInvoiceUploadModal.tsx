...
export default function AtkInvoiceUploadModal({ open, onClose, onDone }: Props) {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    setBusy(true);
    try {
      await api.uploadAtkInvoice(nama.trim(), bulan, file);
    ...
    <ModalOverlay open={open} onClose={handleClose} className="modal-overlay modal-overlay-centered">
      <div className="modal" style={{ maxWidth: 420 }}>
        ...
        <form ref={formRef} onSubmit={handleSubmit}>
          <div className="field">
            <label htmlFor="atk-invoice-upload-nama">Nama Pengirim Invoice</label>
            <input
              type="text"
              id="atk-invoice-upload-nama"
              required
              maxLength={255}
              value={nama}
          ...
          <div className="field">
            <label htmlFor="atk-invoice-upload-bulan">Bulan Invoice</label>
            <MonthFilterPicker id="atk-invoice-upload-bulan" value={bulan} onChange={setBulan} placeholder="Pilih bulan" fillWidth />
          </div>
          <div className="field">
            <label htmlFor="atk-invoice-upload-file">File Invoice (PDF)</label>
            <div
