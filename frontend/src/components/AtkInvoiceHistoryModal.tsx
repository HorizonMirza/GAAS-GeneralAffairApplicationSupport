...
export default function AtkInvoiceHistoryModal({ open, invoiceId, onClose }: Props) {
                    ...
                    <div className="approval-log-body">
                      ...
                      {log.originalFilename && invoiceId != null && (
                        <div style={{ marginTop: 8, display: "flex", alignItems: "center", gap: 8 }}>
                          <a className="btn btn-secondary btn-sm" style={{ width: "auto", padding: "4px 10px", fontSize: "0.75rem", textDecoration: "none" }} href={api.atkInvoiceLogFileUrl(invoiceId, log.id)} target="_blank" rel="noopener noreferrer">Lihat PDF</a>
                          <a className="btn btn-secondary btn-sm" style={{ width: "auto", padding: "4px 10px", fontSize: "0.75rem", textDecoration: "none" }} href={api.atkInvoiceLogDownloadUrl(invoiceId, log.id)}>Download PDF</a>
                        </div>
                      )}
                    </div>
                  </div>
