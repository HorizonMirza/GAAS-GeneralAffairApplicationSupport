...
// Full-screen panel (not a small centered modal) listing every module's PIC at once - Escape
// closes it, same as every other modal in the app, but there's no backdrop to click since the
// panel itself covers the whole viewport.
export default function ContactPersonModal({ open, onClose }: Props) {
  ...
  return (
    <div className="contact-fullscreen">
      <div className="contact-fullscreen-header">
        <h2>Contact Person</h2>
        <button type="button" className="modal-close" onClick={onClose}>&times;</button>
      </div>
      <div className="contact-fullscreen-body">
        <div className="contact-fullscreen-grid">
