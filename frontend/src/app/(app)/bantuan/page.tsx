...
const FAQ_ITEMS: { question: string; answer: string }[] = [
  ...
  },
  {
    ...
    answer:
      "Draft berarti data belum diajukan dan masih bebas diedit atau dihapus. On-Approval berarti sedang menunggu persetujuan, dengan nama tingkat yang sedang memprosesnya langsung tertulis di badge-nya (contoh: \"On-Approval: Admin GA\"). Rejected berarti ditolak dan pengajuan itu dianggap selesai/gagal - badge-nya langsung menyebut tingkat mana yang menolak (contoh: \"Rejected: Approval Departemen\"), dan kalau masih menunggu Anda merevisi dan mengajukan ulang, badge kedua \"Waiting: ...\" di bawahnya menunjukkan siapa yang harus Anda hubungi. Approved berarti pengajuan sudah lolos semua tingkat approval dan resmi disetujui.",
  },
  {
