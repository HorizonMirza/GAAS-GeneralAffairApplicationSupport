...
// Placeholder avatar until real photos exist - a plain emoji, not initials/text.
const AVATAR_EMOJI = "🧑";
      ...
      <div className="contact-page-grid">
        {CONTACT_PERSONS.map((c) => (
          <div key={c.module} className="contact-card">
            <span className="contact-card-avatar">{AVATAR_EMOJI}</span>
            ...
            <div className="contact-card-actions">
              <a
                className="contact-card-btn contact-card-btn-wa"
                href={waLink(c.phone)}
                target="_blank"
                rel="noopener noreferrer"
                aria-label={`Chat WhatsApp ${c.name}`}
              >
