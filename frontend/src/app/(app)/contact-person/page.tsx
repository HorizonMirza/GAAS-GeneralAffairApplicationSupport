...
// overwriting /public/assets/contacts/<slug>.png, no code change needed.
            ...
            <div className="contact-card-body">
              ...
              <div className="contact-card-actions">
                ...
                >
                  ...
                  <span className="contact-card-btn-label">WhatsApp</span>
                </a>
                <a
                  className="contact-card-btn"
                  href={`mailto:${c.email}`}
                ...
                >
                  ...
                  <span className="contact-card-btn-label">Email</span>
                </a>
              </div>
            </div>
          </div>
