...
export default function VehicleBookingOverviewPage() {
  ...
  const load = useCallback(async () => {
    ...
    setBusy(true);
    try {
      const queue = await api.listKendaraanBooking({ limit: 10, page: 1, sejakBulan: currentYearMonth() }).then((r) => r.items);
      setItems(queue);
    } finally {
      setBusy(false);
    }
            ...
            return (
              ...
              >
                ...
                <div className="room-card-icon">
                  <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M5 17h14M5 17a2 2 0 1 0 0 4 2 2 0 0 0 0-4Zm14 0a2 2 0 1 0 0 4 2 2 0 0 0 0-4ZM5 17V9l2-5h10l2 5v8"></path><path d="M3 11h18"></path></svg>
                </div>
              ...
              <div className="card-header">
                <div className="card-header-title">
                  ...
                  <div className="text-secondary" style={{ fontSize: "0.82rem" }}>
                    {formatDate(item.tanggal)} · {formatTimeRange(item.jamMulai, item.jamSelesai, item.isWholeDay)} · {item.namaKendaraan}
                  </div>
                </div>
